...
import icon from '../../resources/favicon-96x96.png?asset'
...
function createWindow() {
  ...
  mainWindow.on('ready-to-show', () => {
    ...
    tray.setToolTip('Trinity Tracker');
...
app.whenReady().then(() => {
  ...
  electronApp.setAppUserModelId('com.beyondcosmos.trinitytracker')
...
ipcMain.handle('fetch-summoner-spells', fetchSummonerSpellData);

ipcMain.handle('fetch-active-player', fetchActivePlayerData);
